    ...
    [
        ...
        pytest.param(
            ...
            [
                "Usage: syncstar [OPTIONS]",
                "Try 'syncstar --help' for help.",
                "Error: Invalid value for '-i' / '--images': Path '/etc/zeroexistent' does not exist.",  # noqa : E501
            ],
            id="Incorrect input - IMAGES"
        ),
    ]
)
def test_clim(cmdl, code, text):
    runner = CliRunner()
