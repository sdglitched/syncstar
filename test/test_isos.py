...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            id="Negative ISOSYAML configuration - Absent config"
        ),
        pytest.param(
            1,
            [
            ...
            id="Negative ISOSYAML configuration - Invalid config"
        ),
        pytest.param(
            2,
            [
            ...
            id="Positive ISOSYAML configuration - Images file present"
        ),
        pytest.param(
            3,
            [
            ...
            id="Negative ISOSYAML configuration - Images file not present",
        ),
        pytest.param(
            4,
            [
            ...
            id="Negative ISOSYAML configuration - Empty config",
        ),
    ]
)
